        ...
        <section className="grid lg:grid-cols-3 gap-4">
          <div className="border border-border bg-card p-5 lg:col-span-2">
            <div className="flex items-start justify-between gap-4 mb-4">
               <div><p className="text-xs font-mono text-emerald-400 uppercase tracking-widest">Daily briefing</p><h2 className="font-semibold mt-1">毎日の報告（本人用）</h2><p className="text-sm text-muted-foreground mt-1">朝は計画、夕方は実績・未完了・学び・明日の最優先を、Xの投稿情報と一緒にまとめます。</p></div>
